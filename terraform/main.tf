...
resource "aws_vpc" "main" {
  ...
  tags = {
    blueprint = "strands agent optimized content distribution for enhanced viewer reach"
    environment = "production"
    Name = "agentbridge-strands-agent-optimized-content-distribu"
    Environment = "production"
    ManagedBy = "terraform"
  }
}
...
resource "aws_internet_gateway" "main" {
  ...
  tags = {
    Name = "agentbridge-strands-agent-optimized-content-distribu-igw"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "agentbridge-strands-agent-optimized-content-distribu-public"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "agentbridge-strands-agent-optimized-content-distribu-rt"
  }
}
...
resource "aws_security_group" "main" {
  name_prefix = "agentbridge-strands-agent-optimized-content-distribu-"
  vpc_id      = aws_vpc.main.id
  ...
  tags = {
    Name = "agentbridge-strands-agent-optimized-content-distribu-sg"
  }
...
resource "aws_key_pair" "deploy" {
  ...
  key_name   = "agentbridge-strands-agent-optimized-content-distribu"
...
resource "aws_eip" "main" {
  ...
  domain   = "vpc"
  tags = {
    Name = "agentbridge-strands-agent-optimized-content-distribu-eip"
  }
}
...
resource "aws_ebs_volume" "data" {
  ...
  encrypted         = true
  tags = {
    Name = "agentbridge-strands-agent-optimized-content-distribu-data"
  }
}
...
resource "aws_iam_role" "bedrock_flow" {
  ...
  name  = "agentbridge-strands-agent-optimized-content-distribu-bedrock-role"
...
resource "aws_iam_role" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-strands-agent-optimized-content-distribu-ec2-bedrock"
...
resource "aws_iam_instance_profile" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-strands-agent-optimized-content-distribu-ec2-profile"
...
resource "aws_bedrockagent_flow" "main" {
  count              = var.enable_bedrock ? 1 : 0
  name               = "agentbridge-strands-agent-optimized-content-distribu-flow"
